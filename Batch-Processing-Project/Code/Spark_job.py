...
class Transformation:
    ...
    def read_parquet_data(self, file_path):
        ...
        try:
            ...
            logging.info("Exception occured:" + str(err))
    ...
    def write_transformed_dataframe(self, df, destination_path, partition_columns = []):
        ...
        try:
            ...
            logging.info("Exception invoked while writing data:" + str(write_err))
    ...
    def write_delta(self, delta_df, df_source, deltaTable, file_name):
        ...
        if file_name == "actives":
            ...
            logging.info("File name not matching, Hence terminating the execution")
            sys.exit(1)
    ...
    def prepare_df_for_SCD2_implementation(self, df, look_up_dict, file_name_delta):
        ...
        if flag:
            logging.info("Successfully updated delta table")
        else:
            logging.info("No changes made in delta table")
...
# Viewership
    ...
    logging.info("raw_viewership_source: ", transform_obj.ingest_raw_viewership_source)
